...
$(document).ready(function() {
  $('#toc').toc({ headers: '.post_main_container h1, .post_main_container h2, .post_main_container h3, .post_main_container h4, .post_main_container h5, .post_main_container h6' });
});